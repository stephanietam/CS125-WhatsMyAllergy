...
//refer to repo for documentation on code
...
public class SettingsPage extends AppCompatActivity {
    ...
    private Button settingsEnableLocation;
    private Button settingsDisableLocation;
...
//        setContentView(R.layout.activity_settings_page);
        ...
        mSettingsClient.checkLocationSettings(mLocationSettingsRequest)
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        ...
                        if (ActivityCompat.checkSelfPermission(SettingsPage.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SettingsPage.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(SettingsPage.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(SettingsPage.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
    ...
    private void setButtonsEnabledState() {
        settingsEnableLocation = findViewById(R.id.settings_enableLocation);
        settingsDisableLocation = findViewById(R.id.settings_disableLocation);
        if (mRequestingLocationUpdates) {


            settingsEnableLocation.setEnabled(false);
            settingsDisableLocation.setEnabled(true);
            ...
            settingsEnableLocation.setVisibility(View.VISIBLE);
            settingsDisableLocation.setVisibility(View.INVISIBLE);
            Log.d(TAG,(String.format(Locale.ENGLISH, "Location DISABLED")));
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            String url = "https://samples.openweathermap.org/data/2.5/forecast?lat=" +mCurrentLocation.getLatitude()+"&lon="+ mCurrentLocation.getLongitude()+"&appid=b6907d289e10d714a6e88b30761fae22";
...
// Access the RequestQueue through your singleton class.
    ...
    private void requestPermissions() {
        ...
        if (shouldProvideRationale) {
            ...
            ActivityCompat.requestPermissions(SettingsPage.this,
